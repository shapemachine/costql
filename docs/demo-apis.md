...
(963 reads asked → 25 SQL queries), which is exactly the API shape that needs
T3's observed sharing and learned **batch-size curves**
...
#    curves. This database's shape needs the sharing trace; the mismatch is
